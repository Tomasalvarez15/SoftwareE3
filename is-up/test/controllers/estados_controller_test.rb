...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { estado: @estado.estado, liked: @estado.liked, liker: @estado.liker } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { estado: @estado.estado, liked: @estado.liked, liker: @estado.liker } }
